...
public class EvenOddRunner {
	public static void main(String[] args) {
		...
		List<Integer> listOfIntegers = Arrays.asList(71, 18, 42, 21, 67, 32, 95, 14, 56, 87,11);
        ...
        Map<Boolean, Long> collect = listOfIntegers.stream().collect(Collectors.partitioningBy(i -> i % 2 == 0, Collectors.counting()));
